										...
										<div class="details">
											<div class="excerpt-container">
												...
												<div class="text-right">
													<p class="help-block">Written by <?=!empty($item->user_id) ? $this->m_user->load($item->user_id)->fullname : 'visa-vietnam.org.vn'?> | <?=date('D, M d, Y',strtotime($item->created_date))?></p>
												</div>
											</div>
										</div>
									</div>
