...
function genVisaTypeOptions()
{
	...
	if (isFree && ($("#visa_type").val() == "1ms")) {
		var msg = "<h3>VIETNAM VISA FOR "+nation.toUpperCase()+" NATIONALITY</h3>";
			...
			msg += "<p><a target='_blank' href='https://www.vietnam-visa.org.vn/news/view/something-change-for-vietnam-visa-on-arrival-from-jul-2015.html'>&rarr; View more about exemption 15 days visa.</a></p>";
			...
			success: function(result) {
				if (result[0]) {
					var msg = "<h3>VIETNAM VISA FOR "+result[1]+" NATIONALITY</h3>";
						...
						msg += "<p>In order to process your visa, please contact us via email address <a href='mailto:visa@vietnam-visa.org.vn'>visa@vietnam-visa.org.vn</a> and supply us your:</p>";
						msg += "<ul>";
